...
void display_bindings() {
    ...
    forth_register("disp-write", fn_write_line);        // disp-write      ( addr line_idx scroll_x y_pixel -- )
    forth_register("disp-write-ml", fn_write_line_ml);  // disp-write-ml   ( addr y_pixel -- )
